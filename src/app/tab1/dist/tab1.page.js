...
var Tab1Page = /** @class */ (function () {
    ...
    Tab1Page.prototype.OpenModel = function (modo) {
        return __awaiter(this, void 0, void 0, function () {
            var presentModel;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.modalCtrl.create({
                            component: modal_page_page_1.ModalPagePage,
                            componentProps: {
                                modo: modo
                            },
                            showBackdrop: true,
                    ...
                    case 1:
                        presentModel = _a.sent();
                        presentModel.onWillDismiss().then(function (data) {
                            console.log(data);
                            //custom code
                        });
                        return [4 /*yield*/, presentModel.present()];
