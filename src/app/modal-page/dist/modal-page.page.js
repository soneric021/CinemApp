...
var ModalPagePage = /** @class */ (function () {
    ...
    ModalPagePage.prototype.ngOnInit = function () {
        ...
        if (this.modo == 1) {
            (_a = this.data).push.apply(_a, Interfaces_1.bebidas);
        }
        else {
            (_b = this.data).push.apply(_b, Interfaces_1.comidas);
        }
    };
    ...
    ModalPagePage.prototype.showSelectValue = function (mySelect) {
...
exports.ModalPagePage = ModalPagePage;
